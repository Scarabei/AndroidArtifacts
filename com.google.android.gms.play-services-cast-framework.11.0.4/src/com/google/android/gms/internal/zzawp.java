...
public final class zzawp extends UIController {
   ...
   public zzawp(View var1, int var2) {
      this.mView = var1;
      this.zzavW = var2;
      this.zzavp = new zzawq(this);
   }
   ...
   private final void zzoo() {
      ...
      if ((var1 = this.getRemoteMediaClient()) != null && var1.hasMediaSession()) {
         ...
         if ((var3 = var1.getMediaStatus()).getQueueRepeatMode() == 0) {
            Integer var4;
            var2 = (var4 = var3.getIndexById(var3.getCurrentItemId())) != null && var4.intValue() < var3.getQueueItemCount() - 1;
         }
   ...
   // $FF: synthetic method
   static RemoteMediaClient zza(zzawp var0) {
