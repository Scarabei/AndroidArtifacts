...
final class zzo extends RemoteMediaClient.zzb {
   ...
   zzo(RemoteMediaClient var1, GoogleApiClient var2, MediaQueueItem[] var3, JSONObject var4) {
      this.zzauy = var1;
      this.zzarg = var3;
      this.zzarc = var4;
      super(var2);
   ...
   protected final void zza(zzaxx var1) {
      synchronized(RemoteMediaClient.zzd(this.zzauy)) {
         try {
            RemoteMediaClient.zze(this.zzauy).zza(this.zzarw, 0, -1L, this.zzarg, 0, (Integer)null, this.zzarc);
