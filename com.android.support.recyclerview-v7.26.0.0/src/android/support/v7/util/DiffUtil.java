...
public class DiffUtil {
   ...
   public static class DiffResult {
      ...
      DiffResult(DiffUtil.Callback callback, List snakes, int[] oldItemStatuses, int[] newItemStatuses, boolean detectMoves) {
         this.mSnakes = snakes;
      ...
      public void dispatchUpdatesTo(ListUpdateCallback updateCallback) {
         ...
         List postponedUpdates = new ArrayList();
         int posOld = this.mOldListSize;
         int posNew = this.mNewListSize;
      ...
      private static DiffUtil.PostponedUpdate removePostponedUpdate(List updates, int pos, boolean removal) {
      ...
      private void dispatchAdditions(List postponedUpdates, ListUpdateCallback updateCallback, int start, int count, int globalIndex) {
         if (!this.mDetectMoves) {
      ...
      private void dispatchRemovals(List postponedUpdates, ListUpdateCallback updateCallback, int start, int count, int globalIndex) {
         if (!this.mDetectMoves) {
