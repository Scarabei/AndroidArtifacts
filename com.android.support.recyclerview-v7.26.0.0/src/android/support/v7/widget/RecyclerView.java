...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
      ...
      if (className != null) {
         ...
         if (!className.isEmpty()) {
            ...
            try {
               ...
               Class layoutManagerClass = classLoader.loadClass(className).asSubclass(RecyclerView.LayoutManager.class);
   ...
   public abstract static class ItemAnimator {
      ...
      @NonNull
      public RecyclerView.ItemAnimator.ItemHolderInfo recordPreLayoutInformation(@NonNull RecyclerView.State state, @NonNull RecyclerView.ViewHolder viewHolder, int changeFlags, @NonNull List payloads) {
   ...
   public abstract static class Adapter {
      ...
      public final RecyclerView.ViewHolder createViewHolder(ViewGroup parent, int viewType) {
         ...
         RecyclerView.ViewHolder holder = this.onCreateViewHolder(parent, viewType);
   ...
   public final class Recycler {
      ...
      View getViewForPosition(int position, boolean dryRun) {
         return this.tryGetViewHolderForPositionByDeadline(position, dryRun, Long.MAX_VALUE).itemView;
      }
   ...
   public static class RecycledViewPool {
      ...
      int size() {
         ...
         for(int i = 0; i < this.mScrap.size(); ++i) {
            ArrayList viewHolders = ((RecyclerView.RecycledViewPool.ScrapData)this.mScrap.valueAt(i)).mScrapHeap;
            if (viewHolders != null) {
      ...
      public void putRecycledView(RecyclerView.ViewHolder scrap) {
         ...
         ArrayList scrapHeap = this.getScrapDataForType(viewType).mScrapHeap;
