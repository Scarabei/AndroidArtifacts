...
public class ItemTouchHelper extends RecyclerView.ItemDecoration implements RecyclerView.OnChildAttachStateChangeListener {
   ...
   public abstract static class Callback {
      ...
      void onDraw(Canvas c, RecyclerView parent, RecyclerView.ViewHolder selected, List recoverAnimationList, int actionState, float dX, float dY) {
      ...
      void onDrawOver(Canvas c, RecyclerView parent, RecyclerView.ViewHolder selected, List recoverAnimationList, int actionState, float dX, float dY) {
         int recoverAnimSize = recoverAnimationList.size();
