...
final class zzbd extends RemoteMediaPlayer.zzb {
   ...
   zzbd(RemoteMediaPlayer var1, GoogleApiClient var2, GoogleApiClient var3, boolean var4, JSONObject var5) {
      this.zzaqV = var1;
      this.zzaqW = var3;
      this.zzarr = var4;
      this.zzarc = var5;
   ...
   protected final void zza(zzaxx var1) {
      synchronized(RemoteMediaPlayer.zze(this.zzaqV)) {
         ...
         try {
            RemoteMediaPlayer.zzg(this.zzaqV).zza(this.zzarw, this.zzarr, this.zzarc);
