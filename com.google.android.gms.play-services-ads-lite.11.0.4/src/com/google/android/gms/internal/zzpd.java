...
public final class zzpd extends zzed implements zzpb {
   zzpd(IBinder var1) {
      super(var1, "com.google.android.gms.ads.internal.formats.client.INativeAppInstallAd");
   }
   ...
   public final double getStarRating() throws RemoteException {
      Parcel var1 = this.zzZ();
      Parcel var2;
      double var3 = (var2 = this.zza(8, var1)).readDouble();
      var2.recycle();
      return var3;
   }
   ...
   public final String getPrice() throws RemoteException {
      Parcel var1 = this.zzZ();
      Parcel var2;
      String var3 = (var2 = this.zza(10, var1)).readString();
      var2.recycle();
      return var3;
   }
   ...
   public final Bundle getExtras() throws RemoteException {
      Parcel var1 = this.zzZ();
      Parcel var2;
      Bundle var3 = (Bundle)zzef.zza(var2 = this.zza(11, var1), Bundle.CREATOR);
      var2.recycle();
      return var3;
   }
   ...
   public final zzks getVideoController() throws RemoteException {
      Parcel var1 = this.zzZ();
      Parcel var2;
      zzks var3 = zzkt.zzg((var2 = this.zza(13, var1)).readStrongBinder());
      var2.recycle();
      return var3;
   }
