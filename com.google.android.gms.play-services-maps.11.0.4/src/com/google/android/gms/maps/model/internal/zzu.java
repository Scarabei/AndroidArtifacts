...
public final class zzu extends zzed implements zzs {
   ...
   public final void setHoles(List var1) throws RemoteException {
      Parcel var2;
      (var2 = this.zzZ()).writeList(var1);
      this.zzb(5, var2);
   }
   ...
   public final List getHoles() throws RemoteException {
      Parcel var1 = this.zzZ();
      Parcel var2;
      ArrayList var3 = zzef.zzb(var2 = this.zza(6, var1));
      var2.recycle();
      return var3;
   }
   ...
   public final boolean zzb(zzs var1) throws RemoteException {
      Parcel var2;
      zzef.zza(var2 = this.zzZ(), var1);
      Parcel var3;
   ...
   public final void setStrokeJointType(int var1) throws RemoteException {
      Parcel var2;
      (var2 = this.zzZ()).writeInt(var1);
      this.zzb(23, var2);
   }
