...
public final class zzbeo extends Fragment implements zzbdt {
   ...
   public static zzbeo zza(FragmentActivity var0) {
      zzbeo var1;
      WeakReference var2;
      if ((var2 = (WeakReference)zzaEH.get(var0)) != null && (var1 = (zzbeo)var2.get()) != null) {
         return var1;
      } else {
         try {
            var1 = (zzbeo)var0.getSupportFragmentManager().findFragmentByTag("SupportLifecycleFragmentImpl");
         ...
         if (var1 == null || var1.isRemoving()) {
            var1 = new zzbeo();
            var0.getSupportFragmentManager().beginTransaction().add(var1, "SupportLifecycleFragmentImpl").commitAllowingStateLoss();
         }
   ...
   public final void zza(String var1, @NonNull zzbds var2) {
      if (!this.zzaEI.containsKey(var1)) {
         ...
         if (this.zzLe > 0) {
            (new Handler(Looper.getMainLooper())).post(new zzbep(this, var2, var1));
         }
   ...
   // $FF: synthetic method
   static int zza(zzbeo var0) {
      return var0.zzLe;
   }

   // $FF: synthetic method
   static Bundle zzb(zzbeo var0) {
      return var0.zzaEJ;
   }
}
