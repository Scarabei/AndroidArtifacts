...
class MediaRouteExpandCollapseButton extends ImageButton {
   ...
   public MediaRouteExpandCollapseButton(Context context, AttributeSet attrs, int defStyleAttr) {
      ...
      this.mExpandAnimationDrawable = (AnimationDrawable)ContextCompat.getDrawable(context, drawable.mr_group_expand);
      this.mCollapseAnimationDrawable = (AnimationDrawable)ContextCompat.getDrawable(context, drawable.mr_group_collapse);
      ...
      this.mExpandGroupDescription = context.getString(string.mr_controller_expand_group);
      this.mCollapseGroupDescription = context.getString(string.mr_controller_collapse_group);
