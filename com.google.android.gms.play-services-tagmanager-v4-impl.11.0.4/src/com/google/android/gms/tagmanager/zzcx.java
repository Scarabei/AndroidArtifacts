...
public class zzcx {
   ...
   static Map zzbEY = new HashMap();

   public static void zzfn(String var0) {
      Class var1 = zzcx.class;
      synchronized(zzcx.class) {
         zzbEX = var0;
      }
   }

   static void zzK(Context var0, String var1) {
      zzfu.zzd(var0, "gtm_install_referrer", "referrer", var1);
      zzM(var0, var1);
   }

   public static String zzL(Context var0, String var1) {
      if (zzbEX == null) {
         Class var2 = zzcx.class;
         synchronized(zzcx.class) {
            if (zzbEX == null) {
   ...
   public static void zzM(Context var0, String var1) {
      String var2;
      if ((var2 = zzV(var1, "conv")) != null && var2.length() > 0) {
         zzbEY.put(var2, var1);
         zzfu.zzd(var0, "gtm_click_referrers", var2, var1);
      }
