...
class PlaybackStateCompatApi21 {
   ...
   public static List getCustomActions(Object stateObj) {
   ...
   public static Object newInstance(int state, long position, long bufferedPosition, float speed, long actions, CharSequence errorMessage, long updateTime, List customActions, long activeItemId) {
      ...
      Iterator var15 = customActions.iterator();

      while(var15.hasNext()) {
         Object customAction = var15.next();
