...
public abstract class FragmentHostCallback extends FragmentContainer {
   ...
   public void onStartActivityFromFragment(Fragment fragment, Intent intent, int requestCode) {
      this.onStartActivityFromFragment(fragment, intent, requestCode, (Bundle)null);
   }
   ...
   SimpleArrayMap retainLoaderNonConfig() {
      ...
      if (this.mAllLoaderManagers != null) {
         ...
         boolean doRetainLoaders = this.getRetainLoaders();
      ...
      return retainLoaders ? this.mAllLoaderManagers : null;
   }
   ...
   void restoreLoaderNonConfig(SimpleArrayMap loaderManagers) {
      if (loaderManagers != null) {
         ...
         for(int N = loaderManagers.size(); i < N; ++i) {
