...
final class BackStackRecord extends FragmentTransaction implements FragmentManager.BackStackEntry, FragmentManagerImpl.OpGenerator {
   ...
   public FragmentTransaction remove(Fragment fragment) {
      this.addOp(new BackStackRecord.Op(3, fragment));
      return this;
   }

   public FragmentTransaction hide(Fragment fragment) {
      this.addOp(new BackStackRecord.Op(4, fragment));
      return this;
   }
   ...
   public FragmentTransaction setPrimaryNavigationFragment(Fragment fragment) {
      this.addOp(new BackStackRecord.Op(8, fragment));
      return this;
   }
   ...
   public void runOnCommitRunnables() {
      if (this.mCommitRunnables != null) {
         ...
         for(int N = this.mCommitRunnables.size(); i < N; ++i) {
   ...
   public FragmentTransaction setAllowOptimization(boolean allowOptimization) {
      return this.setReorderingAllowed(allowOptimization);
   }
            ...
            if (container != 0 && container != lastContainer) {
               ...
               for(int i = startIndex; i < endIndex; ++i) {
                  ...
                  for(int thoseOpIndex = 0; thoseOpIndex < numThoseOps; ++thoseOpIndex) {
                     BackStackRecord.Op thatOp = (BackStackRecord.Op)record.mOps.get(thoseOpIndex);
   ...
   private static boolean isFragmentPostponed(BackStackRecord.Op op) {
