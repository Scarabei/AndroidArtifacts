...
public class FragmentController {
   ...
   public List getActiveFragments(List actives) {
   ...
   public void restoreAllState(Parcelable state, List nonConfigList) {
      this.mHost.mFragmentManager.restoreAllState(state, new FragmentManagerNonConfig(nonConfigList, (List)null));
   }
   ...
   public void restoreLoaderNonConfig(SimpleArrayMap loaderManagers) {
