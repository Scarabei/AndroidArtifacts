...
public class MenuBuilder implements SupportMenu {
   ...
   private void setShortcutsVisibleInner(boolean shortcutsVisible) {
      this.mShortcutsVisible = shortcutsVisible && this.mResources.getConfiguration().keyboard != 1 && this.mResources.getBoolean(bool.abc_config_showMenuShortcutsWhenKeyboardPresent);
   }
   ...
   MenuItemImpl findItemWithShortcutForKey(int keyCode, KeyEvent event) {
      ArrayList items = this.mTempShortcutItemList;
      items.clear();
   ...
   public void flagActionItems() {
      ArrayList visibleItems = this.getVisibleItems();
