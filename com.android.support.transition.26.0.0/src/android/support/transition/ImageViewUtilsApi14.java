...
class ImageViewUtilsApi14 implements ImageViewUtilsImpl {
   public void startAnimateTransform(ImageView view) {
      ...
      view.setTag(id.save_scale_type, scaleType);
      if (scaleType == ScaleType.MATRIX) {
         view.setTag(id.save_image_matrix, view.getImageMatrix());
      } else {
   ...
   public void reserveEndAnimateTransform(final ImageView view, Animator animator) {
      animator.addListener(new AnimatorListenerAdapter() {
         public void onAnimationEnd(Animator animation) {
            ScaleType scaleType = (ScaleType)view.getTag(id.save_scale_type);
            view.setScaleType(scaleType);
            view.setTag(id.save_scale_type, (Object)null);
            if (scaleType == ScaleType.MATRIX) {
               view.setImageMatrix((Matrix)view.getTag(id.save_image_matrix));
               view.setTag(id.save_image_matrix, (Object)null);
            }
