...
public final class FontRequest {
   ...
   public FontRequest(@NonNull String providerAuthority, @NonNull String providerPackage, @NonNull String query, @NonNull List certificates) {
   ...
   public String toString() {
      ...
      for(int i = 0; i < this.mCertificates.size(); ++i) {
         builder.append(" [");
         List set = (List)this.mCertificates.get(i);
