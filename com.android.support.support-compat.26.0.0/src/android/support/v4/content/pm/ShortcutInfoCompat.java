...
public class ShortcutInfoCompat {
   ...
   public static class Builder {
      ...
      @NonNull
      public ShortcutInfoCompat.Builder setShortLabel(@NonNull CharSequence shortLabel) {
         this.mInfo.mLabel = shortLabel;
         return this;
      }

      @NonNull
      public ShortcutInfoCompat.Builder setLongLabel(@NonNull CharSequence longLabel) {
         this.mInfo.mLongLabel = longLabel;
         return this;
      }

      @NonNull
      public ShortcutInfoCompat.Builder setDisabledMessage(@NonNull CharSequence disabledMessage) {
      ...
      @NonNull
      public ShortcutInfoCompat.Builder setIntents(@NonNull Intent[] intents) {
      ...
      /** @deprecated */
      @NonNull
      public ShortcutInfoCompat.Builder setIcon(@NonNull Bitmap icon) {
         return this.setIcon(IconCompat.createWithBitmap(icon));
      }

      /** @deprecated */
      @NonNull
      public ShortcutInfoCompat.Builder setIcon(@DrawableRes int icon) {
         return this.setIcon(IconCompat.createWithResource(this.mInfo.mContext, icon));
      }
      ...
      @NonNull
      public ShortcutInfoCompat.Builder setActivity(@NonNull ComponentName activity) {
