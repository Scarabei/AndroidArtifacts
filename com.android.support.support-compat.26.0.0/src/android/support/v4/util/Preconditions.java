...
public class Preconditions {
   ...
   @NonNull
   public static CharSequence checkStringNotEmpty(CharSequence string) {
   ...
   @NonNull
   public static CharSequence checkStringNotEmpty(CharSequence string, Object errorMessage) {
      if (TextUtils.isEmpty(string)) {
         throw new IllegalArgumentException(String.valueOf(errorMessage));
      } else {
         return string;
   ...
   public static Object[] checkArrayElementsNotNull(Object[] value, String valueName) {
      if (value == null) {
   ...
   @NonNull
   public static Collection checkCollectionElementsNotNull(Collection value, String valueName) {
      if (value == null) {
         throw new NullPointerException(valueName + " must not be null");
      } else {
         long ctr = 0L;
   ...
   public static Collection checkCollectionNotEmpty(Collection value, String valueName) {
      if (value == null) {
         throw new NullPointerException(valueName + " must not be null");
