...
public class AccessibilityNodeInfoCompat {
   ...
   static AccessibilityNodeInfoCompat wrapNonNullInstance(Object object) {
      return object != null ? new AccessibilityNodeInfoCompat(object) : null;
   }
   ...
   public List findAccessibilityNodeInfosByText(String text) {
      ...
      List infos = this.mInfo.findAccessibilityNodeInfosByText(text);
   ...
   public AccessibilityNodeInfoCompat.CollectionInfoCompat getCollectionInfo() {
      ...
      return info == null ? null : new AccessibilityNodeInfoCompat.CollectionInfoCompat(info);
   }

   public void setCollectionInfo(Object collectionInfo) {
      IMPL.setCollectionInfo(this.mInfo, ((AccessibilityNodeInfoCompat.CollectionInfoCompat)collectionInfo).mInfo);
   }

   public void setCollectionItemInfo(Object collectionItemInfo) {
      IMPL.setCollectionItemInfo(this.mInfo, ((AccessibilityNodeInfoCompat.CollectionItemInfoCompat)collectionItemInfo).mInfo);
   }
   ...
   public AccessibilityNodeInfoCompat.CollectionItemInfoCompat getCollectionItemInfo() {
      ...
      return info == null ? null : new AccessibilityNodeInfoCompat.CollectionItemInfoCompat(info);
   }

   public AccessibilityNodeInfoCompat.RangeInfoCompat getRangeInfo() {
      Object info = IMPL.getRangeInfo(this.mInfo);
      return info == null ? null : new AccessibilityNodeInfoCompat.RangeInfoCompat(info);
   }
   ...
   public List getActionList() {
      List actions = IMPL.getActionList(this.mInfo);
      if (actions == null) {
         ...
         for(int i = 0; i < actionCount; ++i) {
            ...
            result.add(new AccessibilityNodeInfoCompat.AccessibilityActionCompat(action));
         }
   ...
   public List findAccessibilityNodeInfosByViewId(String viewId) {
      List nodes = IMPL.findAccessibilityNodeInfosByViewId(this.mInfo, viewId);
      if (nodes == null) {
         return Collections.emptyList();
      } else {
         List result = new ArrayList();
         ...
         while(var4.hasNext()) {
            AccessibilityNodeInfo node = (AccessibilityNodeInfo)var4.next();
   ...
   static class AccessibilityNodeInfoApi21Impl extends AccessibilityNodeInfoCompat.AccessibilityNodeInfoApi19Impl {
      ...
      public List getActionList(AccessibilityNodeInfo info) {
   ...
   static class AccessibilityNodeInfoApi19Impl extends AccessibilityNodeInfoCompat.AccessibilityNodeInfoApi18Impl {
      ...
      public CharSequence getRoleDescription(AccessibilityNodeInfo info) {
         Bundle extras = this.getExtras(info);
      ...
      public void setRoleDescription(AccessibilityNodeInfo info, CharSequence roleDescription) {
         Bundle extras = this.getExtras(info);
         extras.putCharSequence("AccessibilityNodeInfo.roleDescription", roleDescription);
      }
   }
   ...
   static class AccessibilityNodeInfoApi18Impl extends AccessibilityNodeInfoCompat.AccessibilityNodeInfoApi17Impl {
      ...
      public List findAccessibilityNodeInfosByViewId(AccessibilityNodeInfo info, String viewId) {
   ...
   public static class RangeInfoCompat {
      ...
      public static AccessibilityNodeInfoCompat.RangeInfoCompat obtain(int type, float min, float max, float current) {
         return new AccessibilityNodeInfoCompat.RangeInfoCompat(AccessibilityNodeInfoCompat.IMPL.obtainRangeInfo(type, min, max, current));
      }
   ...
   public static class CollectionItemInfoCompat {
      ...
      public static AccessibilityNodeInfoCompat.CollectionItemInfoCompat obtain(int rowIndex, int rowSpan, int columnIndex, int columnSpan, boolean heading, boolean selected) {
         return new AccessibilityNodeInfoCompat.CollectionItemInfoCompat(AccessibilityNodeInfoCompat.IMPL.obtainCollectionItemInfo(rowIndex, rowSpan, columnIndex, columnSpan, heading, selected));
      }
      ...
      public static AccessibilityNodeInfoCompat.CollectionItemInfoCompat obtain(int rowIndex, int rowSpan, int columnIndex, int columnSpan, boolean heading) {
         return new AccessibilityNodeInfoCompat.CollectionItemInfoCompat(AccessibilityNodeInfoCompat.IMPL.obtainCollectionItemInfo(rowIndex, rowSpan, columnIndex, columnSpan, heading));
      }
   ...
   public static class CollectionInfoCompat {
      ...
      public static AccessibilityNodeInfoCompat.CollectionInfoCompat obtain(int rowCount, int columnCount, boolean hierarchical, int selectionMode) {
         return new AccessibilityNodeInfoCompat.CollectionInfoCompat(AccessibilityNodeInfoCompat.IMPL.obtainCollectionInfo(rowCount, columnCount, hierarchical, selectionMode));
      }

      public static AccessibilityNodeInfoCompat.CollectionInfoCompat obtain(int rowCount, int columnCount, boolean hierarchical) {
         return new AccessibilityNodeInfoCompat.CollectionInfoCompat(AccessibilityNodeInfoCompat.IMPL.obtainCollectionInfo(rowCount, columnCount, hierarchical));
      }
