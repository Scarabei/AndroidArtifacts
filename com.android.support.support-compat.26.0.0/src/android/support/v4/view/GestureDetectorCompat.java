...
public final class GestureDetectorCompat {
   ...
   public GestureDetectorCompat(Context context, OnGestureListener listener, Handler handler) {
      if (VERSION.SDK_INT > 17) {
         this.mImpl = new GestureDetectorCompat.GestureDetectorCompatImplJellybeanMr2(context, listener, handler);
      } else {
         this.mImpl = new GestureDetectorCompat.GestureDetectorCompatImplBase(context, listener, handler);
      }
   ...
   static class GestureDetectorCompatImplBase implements GestureDetectorCompat.GestureDetectorCompatImpl {
      ...
      public GestureDetectorCompatImplBase(Context context, OnGestureListener listener, Handler handler) {
         if (handler != null) {
            this.mHandler = new GestureDetectorCompat.GestureDetectorCompatImplBase.GestureHandler(handler);
         } else {
         ...
         if (listener instanceof OnDoubleTapListener) {
            this.setOnDoubleTapListener((OnDoubleTapListener)listener);
         }
      ...
      public boolean onTouchEvent(MotionEvent ev) {
         ...
         case 1:
            ...
            if (this.mIsDoubleTapping) {
               ...
               distance = ev.getPointerId(0);
               velocityTracker.computeCurrentVelocity(1000, (float)this.mMaximumFlingVelocity);
               float velocityY = velocityTracker.getYVelocity(distance);
               float velocityX = velocityTracker.getXVelocity(distance);
